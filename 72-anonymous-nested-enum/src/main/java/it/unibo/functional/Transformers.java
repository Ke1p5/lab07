...
public final class Transformers {
    ...
    public static <I, O> List<O> transform(final Iterable<I> base, final Function<I, O> transformer) {
        final var result = new ArrayList<O>();
        for (final I input : Objects.requireNonNull(base, "All your bases are belong to us")) {
    ...
    public static <I> List<? extends I> flatten(final Iterable<? extends Collection<? extends I>> base) {
        ...
        for (final Collection<? extends I> input: Objects.requireNonNull(base, "All your bases are belong to us")) {
            for (final I elem: Objects.requireNonNull(input, "All your bases are belong to us")) {
                result.add(elem);
            }
        }
        return result;
